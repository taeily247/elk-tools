...
-r, --remove              : Remove  ELK<br>
-u, --user [ STRING ]     : ELK User (deafult: app)<br>
-s, --svr  [ STRING ]     : ELK Service name (deafult: elk-test.com)<br>
-p, --path [ STRING ]     : ELK Path (deafult: /DATA)<br>
-v, --ver  [   INT  ]     : ELK Version (deafult: 9.0.3)<br>
--min-mem  [ INT Gb ]     : JVM Heap Minimum size (default: 6g)<br>
--max-mem  [ INT Gb ]     : JVM Heap Maximum size (default: 6g)<br>
